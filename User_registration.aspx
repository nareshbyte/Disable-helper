...
<head runat="server">
    ...
    <style>
        ...
        body {
            background: url('Images/handicap9.jpg') no-repeat;
            background-size: cover;
        }
        .panel{
              background-color: #49534880;
                    ...
                    <div class="panel panel-body">
                        <div class=" col-md-offset-3">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <asp:TextBox runat="server" ID="txtlname" placeholder="Last Name
"
                                        CssClass="form-control " />
                                    <asp:RequiredFieldValidator ForeColor="Red" ControlToValidate="txtlname" ID="RequiredFieldValidator4" runat="server" ErrorMessage="Enter Name" Display="Dynamic" ValidationGroup="g1"> </asp:RequiredFieldValidator>
                                    <asp:RegularExpressionValidator ValidationExpression="[a-z A-Z]+" ValidationGroup="g1" ControlToValidate="txtlname" ID="RegularExpressionValidator4" runat="server" ErrorMessage="Enter Only Alphabates" Display="Dynamic" ForeColor="Red"></asp:RegularExpressionValidator>
                                </div>
                            </div>
                            <div class="form-group">
