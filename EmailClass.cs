...
public class EmailClass
{
    public static void SendEmailId(string ToEmail, string Subj, string Message)
    {
        ...
        mailMessage.From = new MailAddress("bloomb574@gmail.com", "Request Details");
        ...
        smtp.Credentials = new System.Net.NetworkCredential("bloomb574@gmail.com", "shreya123"); // for password based authentiction schemes
        smtp.EnableSsl = true;
